...
export type CreateEventType<T extends EventNames, K extends string> = `${T}${K}`;
...
export type HierarchyEvents = {
    CHANGED: CreateEventType<EventNames.HIERARCHY, 'CHANGED'>,
    ENTITY_REMOVED: CreateEventType<EventNames.HIERARCHY, 'ENTITY_REMOVED'>,
    TRANSFORM_DIRTY: CreateEventType<EventNames.HIERARCHY, 'TRANSFORM_DIRTY'>,
};
...
export type AllEventTypes =
    ...
    | HierarchyEvents[keyof HierarchyEvents]
