 ...
 * @typedef {'audio' | 'light' | 'input' | 'transform' | 'animation' | 'anim-machine' | 'sprite' | 'script' | 'physics' | 'collider' | 'physicsBody' | 'particle' | 'velocity'} ComponentType
 */
declare type ComponentType = 'audio' | 'light' | 'input' | 'transform' | 'animation' | 'anim-machine' | 'sprite' | 'script' | 'physics' | 'collider' | 'physicsBody' | 'particle' | 'velocity';
