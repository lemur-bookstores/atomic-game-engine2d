...
declare module 'atomic-game-engine2d-components' {
    import { AnimationState } from "@/graphics";
    import { PhysicsBodyType } from "@/physics";
    import { AnimationDirection, Color, Component, ComponentEntry, EntityElement, PlaybackHandle, ShapeType, Vector2D } from "atomic-game-engine2d-types";
    /**
     ...
     */
    declare interface InputComponent extends Component {
        type: 'input';
        moveSpeed: number;
     ...
     */
    declare interface LightInstance {
        id: string;
     ...
     */
    declare interface LightComponent extends Component {
        type: 'light';
     ...
     */
    declare interface TransformComponent extends Component {
        type: 'transform';
        position: Vector2D;
        rotation: number;
        scale: Vector2D;
     ...
     */
    declare interface SpriteComponent extends Component {
        type: 'sprite';
        texture: string;
        width: number;
        height: number;
     ...
     */
    declare interface ParticleComponent extends Component {
        type: 'particle';
        color: Color;
     ...
     */
    declare interface SpriteAnimation {
        name: string;
        frames: number[];
        duration: number;
        loop: boolean;
     ...
     */
    declare interface AnimationComponent extends Component {
        type: 'animation';
        spriteSheet: string;
    ...
    declare interface FrameEventData {
        eventName: string;
        data?: any;
     ...
     */
    declare interface AnimationStateMachineComponent extends Component {
        type: 'anim-machine';
     ...
     */
    declare interface AudioComponent extends Component {
        type: 'audio';
        clip: string;
        loop?: boolean;
        volume?: number;
     ...
     */
    declare interface PhysicsComponent extends Component {
        type: 'physics';
     ...
     */
    declare interface ColliderComponent extends Component {
        type: 'collider';
        width: number;
        height: number;
        isTrigger: boolean;
     ...
     */
    declare interface PhysicsBodyComponent extends Component {
     ...
     */
    declare interface VelocityComponent {
        type: 'velocity';
        x: number;
        y: number;
    }

    declare interface HierarchyComponent extends Component {
        type: "hierarchy";
     ...
     */
    declare type ComponentsSystem = ScriptComponent
        | InputComponent
        | LightComponent
        | HierarchyComponent
        | TransformComponent
